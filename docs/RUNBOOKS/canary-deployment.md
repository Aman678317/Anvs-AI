...
| :--------------------- | :-------------------- | :------------ | :--------------------------------------- |
| **Stage 1 (Internal)** | 5% (Internal Tenants) | 15 minutes    | Zero 5xx, P95 audio latency < 1200ms     |
| **Stage 2 (Canary)**   | 25% of all traffic    | 30 minutes    | STT WER < 12%, zero unhandled exceptions |
| **Stage 3 (Half)**     | 50% of all traffic    | 30 minutes    | Realtime WS caption latency < 50ms       |
...
2. **E2E Audio Latency**: P95 glass-to-glass latency > 1500ms.
